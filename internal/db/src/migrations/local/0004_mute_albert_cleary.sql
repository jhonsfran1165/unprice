...
ALTER TABLE "unprice_customers" ADD COLUMN "timezone" varchar(32) DEFAULT 'UTC';--> statement-breakpoint
ALTER TABLE "unprice_projects" ADD COLUMN "timezone" varchar(32) DEFAULT 'UTC';--> statement-breakpoint
ALTER TABLE "unprice_subscriptions" ADD COLUMN "timezone" varchar(32) DEFAULT 'UTC';--> statement-breakpoint
ALTER TABLE "unprice_customers" DROP COLUMN IF EXISTS "created_at_temporal";