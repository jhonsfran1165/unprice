...
SELECT
    now() - interval 4 hour AS timestamp, 'page_pricing' AS page_id,
    'proj_1234567889' AS project_id, 'session_conversion_4' AS session_id,
...
SELECT
    now() - interval 5 hour AS timestamp, 'page_pricing' AS page_id,
    'proj_1234567889' AS project_id, 'session_no_click' AS session_id,
...
SELECT
    now() - interval 6 hour AS timestamp, 'page_signup' AS page_id,
    'proj_1234567889' AS project_id, 'session_click_no_signup' AS session_id,
...
INSERT INTO unprice_events (timestamp, project_id, session_id, action, version, payload)

-- Plan clicks that follow from the page views
SELECT now() - interval 1 hour + interval 5 minute AS timestamp, 'proj_1234567889' AS project_id, 'session_conversion_1' AS session_id, 'plan_click' AS action, '1' AS version,
    '{"plan_version_id":"pv_starter_v1","page_id":"page_pricing"}' AS payload

UNION ALL
SELECT now() - interval 2 hour + interval 10 minute AS timestamp, 'proj_1234567889' AS project_id, 'session_conversion_2' AS session_id, 'plan_click' AS action, '1' AS version,
    '{"plan_version_id":"pv_pro_v2","page_id":"page_pricing"}' AS payload

UNION ALL
SELECT now() - interval 3 hour + interval 8 minute AS timestamp, 'proj_1234567889' AS project_id, 'session_conversion_3' AS session_id, 'plan_click' AS action, '1' AS version,
    '{"plan_version_id":"pv_enterprise_v1","page_id":"page_pricing"}' AS payload

UNION ALL
SELECT now() - interval 4 hour + interval 15 minute AS timestamp, 'proj_1234567889' AS project_id, 'session_conversion_4' AS session_id, 'plan_click' AS action, '1' AS version,
    '{"plan_version_id":"pv_pro_v2","page_id":"page_pricing"}' AS payload

UNION ALL
SELECT now() - interval 6 hour + interval 3 minute AS timestamp, 'proj_1234567889' AS project_id, 'session_click_no_signup' AS session_id, 'plan_click' AS action, '1' AS version,
    '{"plan_version_id":"pv_basic_v3","page_id":"page_signup"}' AS payload

UNION ALL

-- Signup events that follow from the clicks
SELECT now() - interval 1 hour + interval 12 minute AS timestamp, 'proj_1234567889' AS project_id, 'session_conversion_1' AS session_id, 'signup' AS action, '1' AS version,
    '{"customer_id":"cus_starter_conversion_1","plan_version_id":"pv_starter_v1","page_id":"page_pricing","status":"signup_success"}' AS payload

UNION ALL
SELECT now() - interval 2 hour + interval 20 minute AS timestamp, 'proj_1234567889' AS project_id, 'session_conversion_2' AS session_id, 'signup' AS action, '1' AS version,
    '{"customer_id":"cus_pro_conversion_2","plan_version_id":"pv_pro_v2","page_id":"page_pricing","status":"signup_success"}' AS payload

UNION ALL
SELECT now() - interval 3 hour + interval 25 minute AS timestamp, 'proj_1234567889' AS project_id, 'session_conversion_3' AS session_id, 'signup' AS action, '1' AS version,
...
UNION ALL
SELECT now() - interval 4 hour + interval 30 minute AS timestamp, 'proj_1234567889' AS project_id, 'session_conversion_4' AS session_id, 'signup' AS action, '1' AS version,
