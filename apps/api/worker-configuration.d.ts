/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 491b92c43f3791183c0e6ad786784a0c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENCRYPTION_KEY" | "AUTH_SECRET" | "CLOUDFLARE_ZONE_ID" | "TINYBIRD_URL" | "EMIT_METRICS_LOGS" | "TINYBIRD_TOKEN" | "NODE_ENV" | "CLOUDFLARE_API_TOKEN" | "BASELIME_APIKEY" | "DATABASE_READ2_URL" | "VERCEL_ENV" | "DATABASE_READ1_URL" | "DATABASE_URL" | "DRIZZLE_LOG" | "EMIT_ANALYTICS">> {}
}
declare module "*.sql" {
	const value: string;
