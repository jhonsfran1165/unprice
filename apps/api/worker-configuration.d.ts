// Generated by Wrangler by running `wrangler types` (hash: 5116a72bc9331f2d46ec2f80855ce743)
// Runtime types generated with workerd@1.20250319.0 2025-03-19 nodejs_compat,nodejs_compat_populate_process_env
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENCRYPTION_KEY" | "COOKIE_ENCRYPTION_KEY" | "AUTH_SECRET" | "CLOUDFLARE_ZONE_ID" | "TINYBIRD_URL" | "EMIT_METRICS_LOGS" | "TINYBIRD_TOKEN" | "NODE_ENV" | "CLOUDFLARE_API_TOKEN" | "DATABASE_READ2_URL" | "VERCEL_ENV" | "DATABASE_READ1_URL" | "DATABASE_URL">> {}
}
declare module "*.sql" {
	const value: string;
