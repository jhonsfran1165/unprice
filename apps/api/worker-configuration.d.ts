/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d1f320eb5eb00f8b376c3bbdd2626447)
// Runtime types generated with workerd@1.20250416.0 2025-03-19 nodejs_compat,nodejs_compat_populate_process_env
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENCRYPTION_KEY" | "COOKIE_ENCRYPTION_KEY" | "AUTH_SECRET" | "CLOUDFLARE_ZONE_ID" | "TINYBIRD_URL" | "EMIT_METRICS_LOGS" | "TINYBIRD_TOKEN" | "NODE_ENV" | "CLOUDFLARE_API_TOKEN" | "BASELIME_APIKEY" | "DRIZZLE_LOG" | "DATABASE_READ2_URL" | "VERCEL_ENV" | "DATABASE_READ1_URL" | "DATABASE_URL">> {}
}
declare module "*.sql" {
	const value: string;
