...
export function DashboardShell(props: {
  ...
  return (
    <div className={cn("flex h-[calc(100vh-3.5rem)] grow flex-row", props.className)}>
      ...
      <main className="flex flex-1 flex-col space-y-12 overflow-y-auto py-8">
        ...
        {props.header && (
          <MaxWidthWrapper className="max-w-screen-2xl">{props.header}</MaxWidthWrapper>
        )}
        ...
        <MaxWidthWrapper className="flex max-w-screen-2xl flex-1 flex-col">
          ...
          {props.sidebar ? (
            <div className="flex flex-col gap-2 md:flex-1 md:flex-row">
              <aside className="flex flex-col md:flex md:w-1/5">{props.sidebar}</aside>
              <div className="flex flex-1 flex-col md:w-4/5">
                <div className={cn("space-y-6", props.className)}>{props.children}</div>
              </div>
            </div>
          ) : (
