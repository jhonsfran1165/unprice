...
export const OPENAI_USER_PROMPT =
  "Here are the latest wireframes. Could you improve the website based on these wireframes and notes and send back just the html file?"
...
export const OPEN_AI_SYSTEM_PROMPT_HTML =
  "Your are an expert software developer, please answer any question related to the following HTML code:"
