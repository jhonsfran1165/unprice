...
import { PRO_TIERS, pricingSubscriptions } from "@/lib/config/subscriptions"
    ...
    <MaxWidthWrapper className="my-10 text-center">
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
        {pricingSubscriptions
          .filter((price) => price.plan !== currentPlan)
          .map(
            ({
              plan,
              tagline,
                  ...
                  {plan === "Pro" ? (
                    <div className="flex flex-col items-center space-y-1">
                      ...
                      <div className="flex items-center">
                        <p className="text-sm">
                          Up to {nFormatter(PRO_TIERS[tier].quota)} link
                          clicks/mo
                        </p>
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>
                                ...
                                links will still work, but you need to upgrade
                                to view their stats/add more links. Link clicks
